        ...
        <div className=" py-12 bg-cover bg-center bg-no-repeat banner" >
            <div className='container mx-auto max-w-6xl flex flex-col lg:flex-row items-center gap-10 lg:gap-20  w-auto md:p-8'>
                ...
                <div className='space-y-10 text-center'>
                    ...
                    <section className='flex items-center justify-center gap-4 socialCard'>
                        <Link className='socialContainer containerOne' to='https://github.com/alifa-ara-heya' target='_blank' >
                            {/* <FaGithub size={30} /> */}
                            <svg className=" socialSvg githubSvg" viewBox="0 0 438.549 438.549">
                                <path
                        ...
                        <Link className='socialContainer containerTwo' to='https://www.linkedin.com/in/alifa-ara' target='_blank'>
                            {/* <FaLinkedin size={30} /> */}

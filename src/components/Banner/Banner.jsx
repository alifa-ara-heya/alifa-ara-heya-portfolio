...
const Banner = () => {
    return (
        <div className=" py-12 bg-cover bg-center bg-no-repeat banner" >
            <div className='container mx-auto max-w-6xl flex lg:flex-row items-center gap-10 lg:gap-20  w-auto md:p-8'>
                ...
                <div className='space-y-10 md:w-1/2 w-3/4'>
                    ...
                    <section className='flex items-center gap-4'>
                        <Link to='https://github.com/alifa-ara-heya' target='_blank'><FaGithub size={20} /></Link>
                        <Link to='https://www.linkedin.com/in/alifa-ara' target='_blank'><FaLinkedin size={20} /></Link>
                    </section>
